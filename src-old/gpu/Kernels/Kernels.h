...
__global__ void MatrixFastPartialTraceKernel(int const m, const int size, REAL *A, REAL *result, int offset, int *jjp, int ncorerows);
__global__ void MatrixFastTraceCsrKernel(int const m, const int size, int *csrRowPtr, int *csrColInd, REAL *csrVal, int nnz, REAL *result, int offset);
