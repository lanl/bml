...
void M_CopyDeviceAsync(Matrix A, Matrix B, int idevice, int istream) {
  ...
  cudaMemcpyAsync(B.Device[0], A.Device[0], A.DM*A.DN*sizeof(REAL), cudaMemcpyDeviceToDevice, stream[idevice][istream]);
...
void M_CopyAsync(Matrix A, Matrix B, int idevice, int istream) {
  ...
  cudaMemcpyAsync(B.Device[0], A.Device[0], A.DM*A.DN*sizeof(REAL), cudaMemcpyHostToDevice, stream[idevice][istream]);
