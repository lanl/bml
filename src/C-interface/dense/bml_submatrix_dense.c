    ...
    int B_M)
{
    ...
    {
        case single_real:
            return bml_extract_submatrix_dense_single_real(A, irow, icol,
                                                           B_N, B_M);
            break;
        case double_real:
    ...
    int icol)
{
    ...
    {
        case single_real:
            bml_assign_submatrix_dense_single_real(A, B, irow, icol);
            break;
        case double_real:
