    ...
    const int core_size)
{
    ...
    {
        case single_real:
            return bml_sum_squares_submatrix_dense_single_real(A, core_pos,
                                                               core_size);
            break;
        case double_real:
            return bml_sum_squares_submatrix_dense_double_real(A, core_pos,
                                                               core_size);
            break;
        case single_complex:
            return bml_sum_squares_submatrix_dense_single_complex(A, core_pos,
                                                                  core_size);
            break;
        case double_complex:
            return bml_sum_squares_submatrix_dense_double_complex(A, core_pos,
                                                                  core_size);
            break;
        default:
            LOG_ERROR("unknown precision\n");
