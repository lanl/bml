    ...
    double threshold)
{
    ...
    {
        case single_real:
            return bml_sum_AB_dense_single_real(A, B, alpha,
                                                      threshold);
            break;
        case double_real:
            return bml_sum_AB_dense_double_real(A, B, alpha,
                                                      threshold);
            break;
        case single_complex:
            return bml_sum_AB_dense_single_complex(A, B, alpha,
                                                         threshold);
            break;
        case double_complex:
            return bml_sum_AB_dense_double_complex(A, B, alpha,
                                                         threshold);
            break;
        default:
            LOG_ERROR("unknown precision\n");
