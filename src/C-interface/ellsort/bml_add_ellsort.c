    ...
    double const threshold)
{
    ...
    {
        case single_real:
            bml_add_ellsort_single_real(A, B, alpha, beta, threshold);
            break;
        case double_real:
    ...
    double const threshold)
{
    ...
    switch (B->matrix_precision)
    {
        case single_real:
            trnorm =
                bml_add_norm_ellsort_single_real(A, B, alpha, beta,
                                                 threshold);
            break;
        case double_real:
            trnorm =
    ...
    double const threshold)
{
    ...
    {
        case single_real:
            bml_add_identity_ellsort_single_real(A, beta, threshold);
            break;
        case double_real:
    ...
    const double threshold)
{
    ...
    {
        case single_real:
            bml_scale_add_identity_ellsort_single_real(A, alpha, beta,
                                                       threshold);
            break;
        case double_real:
