    ...
    double threshold)
{
    ...
    switch (B->matrix_precision)
    {
        case single_real:
            trnorm =
                bml_add_norm_csr_single_real(A, B, alpha, beta,
                                                 threshold);
            break;
        case double_real:
            trnorm =
                bml_add_norm_csr_double_real(A, B, alpha, beta,
                                                 threshold);
            break;
        case single_complex:
            trnorm =
                bml_add_norm_csr_single_complex(A, B, alpha, beta,
                                                    threshold);
            break;
        case double_complex:
            trnorm =
                bml_add_norm_csr_double_complex(A, B, alpha, beta,
                                                    threshold);
            break;
        default:
            LOG_ERROR("unknown precision\n");
    ...
    double threshold)
{
    ...
    {
        case single_real:
            bml_scale_add_identity_csr_single_real(A, alpha, beta,
                                                       threshold);
            break;
        case double_real:
            bml_scale_add_identity_csr_double_real(A, alpha, beta,
                                                       threshold);
            break;
        case single_complex:
